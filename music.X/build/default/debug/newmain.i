...
# 70 "newmain.c"
volatile unsigned int song_choice = 2;
volatile unsigned int size = 108;
volatile unsigned int prev_song_choice=2;

const unsigned int melodies[3][120] = {
    {349 ,0,349,0,349,0,330,0,330,0,330,0,247,0,247,0,261,0,294,0,
     330,0,330,0,330,0,294,0,294,0,294,0,294,0,261,0,330,0,
    349 ,0,349,0,349,0,330,0,330,0,330,0,247,0,247,0,261,0,294,0,
            294,0,330,0,330,0,330,0,330,0,294,0,261,0,392,0,261,0,247,0,261,0

    },
    {523,0, 587, 0, 494, 0,523,0, 587,0, 494,0, 523, 0, 587, 0, 494, 0, 523, 0, 494, 0, 523, 0,587,0,
     440, 0, 494, 0, 392, 0, 440, 0, 494, 0,392 , 0,440 ,0,494, 0,392, 0,440,0,392,0,440,0,494,0,
     523,0, 587, 0, 494, 0,523,0, 587,0, 494,0, 523, 0, 587, 0, 494, 0, 523, 0, 494, 0, 523, 0,587,0,
     440, 0, 494, 0, 392, 0, 440, 0, 494, 0,392 , 0,440 ,0,494, 0,392, 0,440,0,392,0,440,0,659,0,587,0,494,0

    },
    {330,0, 392, 0, 330, 0,370,0, 392,0, 370,0, 294, 0, 330, 0, 370, 0, 392, 0, 370, 0, 294, 0,330,0
    }
};

const unsigned int durations[3][120] = {
...
const unsigned char lights[3][120] = {
    {7,0,7,0,7,0,1,0,2,0,4,0,5,0,2,0,5,0,2,0,
     7,0,7,0,7,0,1,0,2,0,4,0,5,0,2,0,7,0,
    7 ,0,7,0,7,0,1,0,2,0,4,0,5,0,2,0,5,0,2,0,
            1,0,2,0,4,0,1,0,2,0,4,0,1,0,5,0,2,7,0,7,0
    ...
    {7,0, 7, 0, 7, 7,1,0, 2,0, 4,0, 1, 0, 2, 0,4 , 0, 1, 0, 2, 0, 4, 0,7,0
    }
};
...
void Set_PWM_Frequency(unsigned int freq) {
    ...
    pwm_period = ((unsigned long)4000000 / (4 * freq * prescaler)) - 1;
    ...
    if (pwm_period <= 255) {
        PR2 =(unsigned char) pwm_period;
        T2CON = (prescaler == 1) ? 0x04 : (prescaler == 4) ? 0x05 : 0x06;
        CCPR1L =(unsigned char) pwm_period / 2;
    }
    else {
        PR2 = 255;
        CCPR1L = 0;
